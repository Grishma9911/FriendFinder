...
* Check out [this demo version of the site](https://friend-finder-fsf.herokuapp.com/). Use this as a model for how this assignment should look like and operate.
...
6. Determine the user's most compatible friend using the following as a guide:
   ...
   * Convert each user's results into a simple array of numbers (ex: `[5, 1, 4, 4, 5]`).
